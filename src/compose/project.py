...
"""Load, parse and validate project."""
...
class ProjectError(Exception):
    """Failed to load, parse or validate project."""
...
class Project(BaseModel, extra='forbid'):
    ...
    def from_repo(cls, url: str, **kwargs):
        ...
        Raises:
            ProjectError: if loading the configuration fails.
        """
        ...
        try:
            ...
            raise ProjectError(msg.format(url, error))
        try:
            ...
            raise ProjectError(msg.format(url))
    ...
    def from_github(cls, url: str, **kwargs):
        ...
        try:
            ...
            raise ProjectError(msg.format(req.full_url, error))
    ...
    def from_yaml(cls, config_yaml: Union[str, TextIO], **kwargs):
        ...
        Raises:
            ProjectError: if parsing or validating the configuration fails.
        """
        ...
        try:
            ...
            raise ProjectError(msg.format(yaml_error))
        ...
        try:
            ...
            raise ProjectError(msg.format(validation_error))
